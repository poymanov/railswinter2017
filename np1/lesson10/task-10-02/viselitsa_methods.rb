...
def check_input(user_input, letters, good_letters, bad_letters)
  ...
  # Равнозначные буквы - е/ё, и/й
  alternative_user_input = nil

  if user_input == 'ё'
    alternative_user_input = 'е'
  elsif user_input == 'е'
    alternative_user_input = 'ё'
  elsif user_input == 'и'
    alternative_user_input = 'й'
  elsif user_input == 'й'
    alternative_user_input = 'и'
  end

  if letters.include?(user_input) || (alternative_user_input && letters.include?(alternative_user_input))
    # Если в слове есть буква запишем её в массив «хороших» букв

    # Заносим альтернативную букву, если она есть
    if alternative_user_input
      good_letters << alternative_user_input
    else
